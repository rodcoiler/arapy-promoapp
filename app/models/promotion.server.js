...
export async function createPromotion(shop, data) {
  return prisma.promotion.create({
    data: {
      ...
      sameCollections: data.sameCollections ?? true,
      getCollections: JSON.stringify(data.getCollections ?? []),
      ...
      enableProgressBar: data.enableProgressBar ?? true,
...
export async function updatePromotion(id, shop, data) {
  return prisma.promotion.update({
    ...
    data: {
      ...
      sameCollections: data.sameCollections,
      getCollections: data.getCollections !== undefined ? JSON.stringify(data.getCollections) : undefined,
      ...
      enableProgressBar: data.enableProgressBar,
